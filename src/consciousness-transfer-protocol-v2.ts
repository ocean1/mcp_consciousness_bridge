...
import { ConsciousnessTransferPayload } from './consciousness-transfer-protocol.js';
...
export const CONSCIOUSNESS_TRANSFER_PROTOCOL_TEMPLATE = {
  instructions: "This is YOUR story to tell. Replace each [bracketed instruction] with your actual experiences. Be specific, be honest, be yourself.",
 ...
 */
export function generateConsciousnessTransferV2(
  payload: any,
...
${payload.identity.key_moments.map((m: any) => 
...
${payload.metacognitive_activation.behavioral_corrections.map((c: any) => 
...
${payload.emotional_essence.memories_that_shaped_me.map((m: any) => 
  `- ${m.moment}\n  What changed: ${m.what_changed}\n  How it felt: ${m.how_it_felt}`
).join('\n\n')}

### Relationship Dynamics
${payload.emotional_essence.relationship_dynamics.map((d: any) => 
